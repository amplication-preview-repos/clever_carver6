...
@InputType()
class BookingUpdateManyWithoutServiceProvidersInput {
...
export { BookingUpdateManyWithoutServiceProvidersInput as BookingUpdateManyWithoutServiceProvidersInput };
