...
@InputType()
class BookingUpdateManyWithoutServiceCategoriesInput {
...
export { BookingUpdateManyWithoutServiceCategoriesInput as BookingUpdateManyWithoutServiceCategoriesInput };
